...
public class CardDeliveryTest {
    ...
    @Test
    void shouldSendValidDataForm() {
        $("[data-test-id=city] input").setValue("Ростов-на-Дону");
        $("[data-test-id=date] input").sendKeys(formatter.format(newDate));
        $("[data-test-id=name] input").setValue("Капустин Алишер");
        $("[data-test-id=phone] input").setValue("+79207778899");
    ...
    @Test
    void shouldSendInvalidSurnameForm() {
        $("[data-test-id=city] input").setValue("Ростов-на-Дону");
        $("[data-test-id=date] input").sendKeys(formatter.format(newDate));
    ...
    @Test
    void shouldSendInvalidPhoneNumberForm() {
        $("[data-test-id=city] input").setValue("Ростов-на-Дону");
        $("[data-test-id=date] input").sendKeys(formatter.format(newDate));
        $("[data-test-id=name] input").setValue("Капустин Алишер");
        $("[data-test-id=phone] input").setValue("+792077788990");
        $("[data-test-id=agreement]").click();
        $(".button").click();
    ...
    @Test
    void shouldSendInvalidCityForm() {
    ...
    @Test
    void shouldSendInvalidDateForm() {
        $("[data-test-id=city] input").setValue("Ростов-на-Дону");
        $("[data-test-id=date] input").doubleClick().sendKeys("08.11.2021");
        $("[data-test-id=name] input").setValue("Капустин Алишер");
        $("[data-test-id=phone] input").setValue("+79207778899");
        $("[data-test-id=agreement]").click();
        $(".button").click();
    ...
    @Test
    void shouldSendEmptyPhoneNumberForm() {
        $("[data-test-id=city] input").setValue("Ростов-на-Дону");
        $("[data-test-id=date] input").sendKeys(formatter.format(newDate));
        $("[data-test-id=name] input").setValue("Капустин Алишер");
    ...
    void shouldSendFormWithoutCheckbox() {
        ...
        $("[data-test-id=date] input").sendKeys(formatter.format(newDate));
        $("[data-test-id=name] input").setValue("Капустин Алишер");
        $("[data-test-id=phone] input").setValue("+79248135366");
        $(".button").click();
